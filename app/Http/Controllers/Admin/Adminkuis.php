...
class Adminkuis extends Controller {
    ...
    function tambah() {
        ...
        return view("admin.kuis.tambah", $data);
    }
    ...
    function update($kuis) {
        ...
        return view("admin.kuis.update", $data);
    }
    ...
    function aksiupdate(Kuis $kuis, Request $request) {
        ...
        $update = $kuis->update();
        if($update == 1) {
            return redirect('admin/kuis')->with("success", "Data berhasil diupdate !");
        } else {
    ...
    function delete(Kuis $kuis) {
        ...
        $delete = $kuis->delete();
        if($delete == 1) {
            return redirect('admin/kuis')->with("success", "Data berhasil dihapus !");
        } else {
