    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-user">
            ...
            <div class="user-captions">
                ...
                <span class="username">{{ $user->nip }}</span>
            </div>
        </div>
        <ul class="sidebar-menu">
            <li class="header">LIST MENU</li>
            <x-layout.guru.menu-btn url="guru/dashboard" icon="mdi-view-dashboard" title="Dashboard" />
            <x-layout.guru.menu-btn url="guru/siswa" icon="mdi-account-multiple" title="Data Siswa" />
            <x-layout.guru.menu-btn url="guru/kuis" icon="mdi mdi-comment-question-outline" title="Data Kuis" />
            <x-layout.guru.menu-btn url="guru/tugas" icon="mdi mdi-comment-text-outline" title="Data Tugas" />
            <x-layout.guru.menu-btn url="guru/ujian" icon="mdi mdi-comment-processing-outline" title="Data Ujian" />
        </ul>
    </aside>
