...
class Siswaujian extends Controller
{
    ...
    public function index()
    {
        ...
        $data['list'] = Ujian::with(['soalujian', 'nilai', 'mapel'])
    ...
    function kirimjawaban(Request $request)
    {
        ...
        if ($simpan == 1) {
            return redirect('siswa/ujian')->with("success", "Jawaban ujian berhasil dikirim");
        } else {
            return redirect('siswa/ujian')->with("danger", "Jawaban ujian gagal dikirm, coba ulangi kembali.");
        }
    }
