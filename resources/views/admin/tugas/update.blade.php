<x-layout.admin.app>
    ...
    <div class="row">
        <div class="col-md-12">
            <x-card.card>
                <x-card.header>
                    <form action="{{ url('admin/tugas/update', $list->id) }}" method="POST" class="pt-3">
                        @csrf
                        <div class="row">
                                    ...
                                    <x-dropdown.content>
                                        @foreach ($mapel as $item)
                                            <x-dropdown.items id="{{ $item->id }}" dataid="{{ $item->mapel }}">
                                                ...
                                                <x-dropdown.list-items title="Kel   as"
                            ...
                            <div class="col-md-4">
                                <x-input.input label="Nama Tugas" name="nama_tugas" value="{{ $list->nama_kuis }}"
                                    placeholder="Masukan nama tugas ..." />
                            </div>
                            <div class="col-md-4">
                                <x-input.input label="Soal Tuga" name="soal_tugas" value="{{ $list->soal_kuis }}"
                            ...
                            <div class="col-md-12">
                                <div class="d-flex align-items-center justify-content-center gap-2">
                                    <a href="{{ url('admin/tugas') }}" class="btn btn-outline-secondary">KEMBALI</a>
