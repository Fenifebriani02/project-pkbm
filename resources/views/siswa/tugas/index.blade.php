    ...
    @if ($list->count() > 0)
        <div class="row">
            <div class="col-md-12">
                <x-card.card>
                    <x-card.header>
                        <h2>Jawablah tugas dibawah ini, yang menurut anda paling benar !</h2>
                    </x-card.header>
                    <x-card.body>
                        <form action="{{ url('siswa/tugas/kirimjawaban') }}" method="POST">
    ...
    @else
        <div class="row">
            <div class="col-md-12">
                <x-card.card>
                    <x-card.header>
                        <h2 class="text-center">Belum ada tugas untuk ditampilkan</h2>
                    </x-card.header>
                </x-card.card>
            </div>
        </div>
